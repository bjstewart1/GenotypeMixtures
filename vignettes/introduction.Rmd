...
experimental_design <- experimental_design[1:10, ] #just the first 8 channels for simplicity
experimental_design
...
file_locations <- file_locations[1:10, ]
head(file_locations)
```
...
#now we can plot genotype VAFs
```{r}
GenotypeMixtures::plot_cross_vaf(file_locations[2, 2], file_locations[3,2], file_locations[2,1], file_locations[3,1])
```
