...
```{r}
dense_design <- make_overlapping_mixture(n_mixtures = 10, n_genotypes = 5, density = 1 )
medium_design <- make_overlapping_mixture(n_mixtures = 10, n_genotypes = 5, density = 0.5 )
sparse_design <- make_overlapping_mixture(n_mixtures = 10, n_genotypes = 5, density = 0 )
plot_experimental_design(dense_design)
plot_experimental_design(medium_design)
